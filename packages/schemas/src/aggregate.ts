...
// Pure aggregation over the shared schema types. Both the collector
// (@lukasparke/diffler) and the renderer (@lukasparke/diffler-remotion)
// build on these, so derived numbers cannot drift between packages.
