...
describe("aggregateLanguages", () => {
  it("aggregates languages from multiple repos", () => {
    const repos = [
      {
        languages: {
          edges: [
...
describe("calculateContributionStats", () => {
  ...
  it("calculates monthly breakdown correctly", () => {
    const collection = createContributionsCollection([
...
describe("calculateComputedStats", () => {
  ...
  it("calculates repo statistics correctly", () => {
    const repos = [
  ...
  it("calculates language statistics correctly", () => {
  ...
  it("calculates year over year growth correctly", () => {
  ...
  it("identifies most productive month", () => {
    const contributionStats = createContributionStats([
  ...
  it("aggregates topics correctly", () => {
    const repos = [
...
describe("v2 collection helpers", () => {
  const baseConfig: StatsActionConfig = {
  ...
  it("merges repositories by id without duplicating contribution counts or sources", () => {
  ...
  it("builds a resumable backfill queue only for stale optional metrics", () => {
  ...
  it("does not queue contributor stats when default branch oid is unchanged", () => {
    const cache = createEmptyStableCache();
    const repo = createRepository();
    cache.contributorStats[repo.id] = {
      additions: 10,
  ...
  it("stores repository metadata without duplicating contribution counts in cache", () => {
    const cache = createEmptyStableCache();
    const repo = createRepository({
      contributionCounts: {
        commits: 10,
  ...
  it("does not store private repository details in stable cache by default", () => {
    const cache = createEmptyStableCache();
