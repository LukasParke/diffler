		...
		>
			<div className="grid h-[158px] grid-cols-[142px_1fr] items-center gap-4">
				<svg viewBox="0 0 120 120" className="h-[118px] w-[118px]">
					<defs>
						<linearGradient
							...
							y2="100%"
						>
							<stop offset="0%" stopColor={defaultTheme.colors.green} />
							<stop offset="100%" stopColor={defaultTheme.colors.cyan} />
						</linearGradient>
					</defs>
					<circle
						cx="60"
				...
				<div className="min-w-0">
					...
					<div className="mt-4">
						<ProgressBar value={current} max={longest} color={defaultTheme.colors.green} />
					</div>
